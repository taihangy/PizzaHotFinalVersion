...
;(function()
{
	 ...
	 * @public
	 */
	evothings.arduinotcp.digitalWrite = function(number)
	{
		internal.sendRequest(number, internal.callbackFun)
	}
	 ...
	 * @public
	 */
	evothings.arduinotcp.writeLocationString = function(loc)
	{
		
		internal.sendRequest(loc, internal.callbackFun);
	}
